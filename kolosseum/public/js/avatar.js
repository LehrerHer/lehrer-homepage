(function () {
  const LEVELS = [
    { name: 'Rekrut',    xpNeeded: 0,    color: '#a0aec0', glow: false, crown: false, sword: false, shield: false },
    { name: 'Gladiator', xpNeeded: 100,  color: '#68d391', glow: false, crown: false, sword: false, shield: false },
    { name: 'Kämpfer',   xpNeeded: 250,  color: '#4299e1', glow: false, crown: false, sword: true,  shield: false },
    { name: 'Krieger',   xpNeeded: 500,  color: '#9f7aea', glow: true,  crown: false, sword: true,  shield: true  },
    { name: 'Veteran',   xpNeeded: 900,  color: '#f6ad55', glow: true,  crown: false, sword: true,  shield: true  },
